package com.bloomhousemc.jojo.client.shader;
...
public class ZaWarudoShader implements PostWorldRenderCallback, ClientTickEvents.StartTick {
    ...
    private ManagedShaderEffect shader = ShaderEffectManager.getInstance().manage(new Identifier(JoJo.MODID,"shaders/post/za_warudo.json"), shader -> {
