...
public final class HamonComponent implements IHamonUser, AutoSyncedComponent, PlayerComponent<HamonComponent> {
    ...
    @Override
    public void copyForRespawn(HamonComponent original, boolean lossless, boolean keepInventory, boolean sameCharacter) {
        if (lossless) {
            copyFrom(original);
        } else {
    ...
    @Override
    public void copyFrom(HamonComponent other) {
        hamon = other.hamon;
